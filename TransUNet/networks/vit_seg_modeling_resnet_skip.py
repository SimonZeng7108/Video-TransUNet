...
if __name__ == "__main__":
    ...
    # y = resnet(x)
    # make_dot(y, params = dict(resnet.named_parameters())).render("attached", format="png")
    # print(resnet)

    from torchsummary import summary
    model = ResNetV2((3, 4, 9), 1).cuda()
    ...
    # make_dot(y.mean(),params=dict(model.named_parameters())).render("Resnet_v2", format="png")